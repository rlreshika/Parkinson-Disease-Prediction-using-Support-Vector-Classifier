...
with col2:
    st.video("https://github.com/sugam21/Parkinson-Disease-Prediction-using-Support-Vector-Classifier/raw/master/video.mp4", format="video/mp4", start_time=0, autplay = True)
